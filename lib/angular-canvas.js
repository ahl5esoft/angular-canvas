	...
	function (animation, strconv) {
		return {
			...
			link: function (scope, el, attrs, nodeCtrl) {
				...
				scope.$watch(el.attr('x-i'), function (v) {
					xIndex = v < xMax ? v : 0;
				});
...
angular.module('ac', ['ac.util.strconv', 'ac.core.animation', 'ac.core.context', 'ac.core.node', 'ac.ui.image', 'ac.ui.label', 'ac.ui.node', 'ac.ui.rect', 'ac.ui.stage', 'ac.attr.base', 'ac.attr.frame-image', 'ac.attr.hover-image', 'ac.attr.image']);